...
class MediaController {
  ...
  async lookupSeries(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async addSeries(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async getSeriesQueue(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async searchSeriesContent(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
      const seriesId = parseInt(id, 10);
  ...
  async sonarrStatus(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async getSeriesProfiles(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async lookupMovie(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async getMoviesQueue(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async searchMovieContent(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
      const movieId = parseInt(id, 10);
  ...
  async radarrStatus(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async getMoviesProfiles(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
